---
title: 'Spatial Cognition and Skills in Immersive Environments'
status: Completed
fundedBy: 'PhD Project'
role: 'PhD Student'
permalink: /projects/spatial/
excerpt: "My research investigates spatial cognition and spatial memory in immersive environments, including Virtual Reality (VR) and Augmented Reality (AR). I study how the design of information displays and the surrounding environment influence people's ability to remember, navigate, and interact with spatially distributed information. This work aims to inform the design of effective immersive analytics and mixed-reality interfaces that better align with human cognitive capabilities."
teaser: /images/projects/website_spatial.jpg
tags:
  - spatial memory
...
<img src="/images/publications/teaser_spatialMemoryISS.png" alt="Spatial Memory Teaser" width="800" height="445"><br>
...
**Liu, J.**, Prouzeau, A., Ens, B. and Dwyer, T., 2022. Effects of display layout on spatial memory for immersive environments. *Proceedings of the ACM on Human-Computer Interaction, 6(ISS), pp.468-488.* [Publication Link](/publication/spatialmemory)
