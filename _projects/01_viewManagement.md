---
title: 'Immersive View Management for Interactive Data Visualisation'
status: Completed
fundedBy: 'PhD Project'
role: 'PhD Student'
permalink: /projects/viewManagement/
excerpt: 'A multi-view data visualisation system uses multiple views to support the investigation of a single conceptual data entity. Data visualisation has traditionally been done on screens. However, emerging technologies like virtual and augmented reality create new possibilities for exploring data in immersive environments. This thesis explores the factors that could influence and inform interface and interaction design for managing multi-view visualisations in immersive spaces. We characterise fundamental design aspects, implement prototypes to demonstrate design possibilities, and evaluate them with user studies. Amongst other findings, our user studies reveal an effect of spatial layout of views on spatial memory and ergonomics.'
teaser: /images/projects/viewManagement.jpg
tags:
  - data visualisation
  - immersive analytics
  - view management
...
<img src="/images/publications/SM_Teaser.png" alt="Small Multiples Teaser" width="800" height="445"><br>
...
<img src="/images/publications/SM_designSpace.PNG" alt="Small Multiples Design Space" width="800" height="445"><br>
